    ...
    <div class="container mx-auto py-12 px-4 md:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-1">
          ...
          <ul class="space-y-2">
            <li><a href="/services#residential" class="text-gray-300 hover:text-secondary">Residential</a></li>
            <li><a href="/services#commercial" class="text-gray-300 hover:text-secondary">Commercial</a></li>
            <li><a href="/services#driveways" class="text-gray-300 hover:text-secondary">Driveways & Sidewalks</a></li>
            <li><a href="/services#decks" class="text-gray-300 hover:text-secondary">Deck & Patio</a></li>
            <li><a href="/services#roofs" class="text-gray-300 hover:text-secondary">Roof Cleaning</a></li>
          </ul>
        </div>
        ...
        <div class="md:col-span-1">
          ...
          <ul class="space-y-2">
            <li class="flex items-start">
              ...
              <span class="text-gray-300">123 Clean Street, Washville, WS 12345</span>
            </li>
            <li class="flex items-start">
              <svg class="h-6 w-6 text-secondary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li class="flex items-start">
              ...
              <span class="text-gray-300">info@simplycpw.com</span>
            </li>
            <li class="mt-4">
